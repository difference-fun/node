...
use Difference\Fun\Module\Parallel;
use Difference\Fun\Module\Parse;
use Difference\Fun\Module\Route;
use Difference\Fun\Module\SharedMemory;
...
/**
 * app difference_fun/node list -class=RaXon.Php.Word.Embedding -page=1 -limit=10 -parallel -thread=96 -ramdisk
 * count 960 duration: 120.88 msec
 * app difference_fun/node list -class=RaXon.Php.Word.Embedding -page=1 -limit=100 -parallel -thread=96 -ramdisk
                ...
                if(File::exist($ramdisk_url_nodelist[0])){
                    ...
                    if($response){
                        if(
                            ...
                            $parse->storage()->data('difference.fun.parse.view.url', $data_url);
                            $parse->storage()->data('difference.fun.parse.view.mtime', $mtime);
