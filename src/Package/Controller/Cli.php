...
namespace Package\Difference\Fun\Node\Controller;
...
class Cli extends Controller {
    ...
    const INFO = [
        '{{binary()}} difference_fun/node                    | Node (Object store) options',
        '{{binary()}} difference_fun/node object             | Node (Object Classes) options',
        '{{binary()}} difference_fun/node setup              | Node setup'
    ];
